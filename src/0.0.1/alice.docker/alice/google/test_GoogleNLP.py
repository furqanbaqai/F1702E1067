...
class TestGoogleNLP(unittest.TestCase):
    ...
    def setUp(self):
        ...
        amqHost = os.environ['AMQ_IP_ADD'] = '192.168.139.180'
        amqPort = os.environ['AMQ_PORT'] = '32770'
        amqUid = os.environ['AMQ_UID'] = 'admin'
        amqPass = os.environ['AMQ_PASS'] = 'admin'
        ...
        os.environ['GOOGLE_API_TOKEN'] = 'AIzaSyDVahL21jLGGCGnbFNIAv6g61ubrgzebSA'
        # setup db connection
